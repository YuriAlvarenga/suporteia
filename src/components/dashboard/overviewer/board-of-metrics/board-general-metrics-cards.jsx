...
export default function TicketMetricsCards() {
    ...
    return (
        <Box sx={{ width: '100%', display: 'flex', flexDirection: 'column', gap: 0 }}>
            ...
            <Box sx={{ p: 1, bgcolor: '#fcfcfc', borderBottom: '1px solid #eee' }}>
                <Stack direction={{ xs: 'column', sm: 'row' }} spacing={1} alignItems="center" justifyContent="flex-end">
                    <Select value={group} onChange={(e) => setGroup(e.target.value)} size="small"
                        sx={{
                            height: 25, fontSize: '0.7rem', minWidth: 130, bgcolor: 'white',
                    ...
                    <Select value={storeFilter} onChange={(e) => setStoreFilter(e.target.value)} size="small"
                        sx={{
                            height: 25, fontSize: '0.7rem', minWidth: 150, bgcolor: 'white',
                    ...
                    <ToggleButtonGroup
                        ...
                        size="small"
                        sx={{ height: 25, bgcolor: 'white', '& .MuiToggleButton-root': { fontSize: '0.65rem', px: 1, textTransform: 'capitalize', border: '1px solid #eee', '&.Mui-selected': { backgroundColor: 'var(--color-highlight)', color: 'white', '&:hover': { backgroundColor: 'var(--color-highlight)', opacity: 0.9 } } } }}
                    >
            ...
            {/* MEIO: Rankings e Gráfico Lado a Lado */}
            <Stack direction={{ xs: 'column', lg: 'row' }} sx={{ p: 0, width: '100%' }} alignItems="stretch" spacing={2}>
                {/* Ranking */}
                <Box sx={{ flex: '1 1 50%', minWidth: 0 }}>
                    <BoardRankingsSection groupRanking={metricsData.groupRanking} userRanking={metricsData.userRanking} />
                </Box>

                {/* Gráfico envolto em Paper para separação visual */}
                <Box sx={{ flex: '1 1 50%', p: 2, minWidth: 0 }}>
            ...
            {/* BASE: Tags pegando todo o espaço */}
